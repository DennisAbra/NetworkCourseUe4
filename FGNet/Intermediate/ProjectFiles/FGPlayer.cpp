...
AFGPlayer::AFGPlayer()
{
	...
	SprintArmComponent = CreateDefaultSubobject<USpringArmComponent>(TEXT("SpringArmComponent"));
...
void AFGPlayer::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
