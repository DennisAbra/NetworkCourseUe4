...
// Cross Module References
	...
	FGNET_API UClass* Z_Construct_UClass_UFGMovementComponent();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFGMovementComponent_Statics::NewProp_Gravity = { "Gravity", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFGMovementComponent, Gravity), METADATA_PARAMS(Z_Construct_UClass_UFGMovementComponent_Statics::NewProp_Gravity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFGMovementComponent_Statics::NewProp_Gravity_MetaData)) };
	...
	IMPLEMENT_CLASS(UFGMovementComponent, 2021472864);
	template<> FGNET_API UClass* StaticClass<UFGMovementComponent>()
	{
		return UFGMovementComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFGMovementComponent(Z_Construct_UClass_UFGMovementComponent, &UFGMovementComponent::StaticClass, TEXT("/Script/FGNet"), TEXT("UFGMovementComponent"), false, nullptr, nullptr, nullptr);
